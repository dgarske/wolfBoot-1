...
#define CSU_STATUS           (*((volatile uint32_t*)(CSU_BASE + 0x0000U)))
#define CSU_STATUS_BOOT_ENC  (1 << 1)
#define CSU_STATUS_BOOT_AUTH (1 << 0)

#define CSU_IDCODE        (*((volatile uint32_t*)(CSU_BASE + 0x0040U)))
#define CSU_VERSION       (*((volatile uint32_t*)(CSU_BASE + 0x0044U)))
/* 0: XCZU9EG-ES1,
...
#define CSU_TAMPER_STATUS (*((volatile uint32_t*)(CSU_BASE + 0x5000U)))
#define CSU_TAMPER_TRIG   (*((volatile uint32_t*)(CSU_BASE + 0x0014U))) /* set =1 to trigger tamber event for testing */

/* SSS - Secure Stream Switch */
#define CSU_SSS_CFG           (*((volatile uint32_t*)(CSU_BASE + 0x0008U)))
...
/* AES-GCM 256-bit */
#define CSU_AES_STATUS    (*((volatile uint32_t*)(CSU_BASE + 0x1000U)))
#define CSU_AES_KEY_SRC   (*((volatile uint32_t*)(CSU_BASE + 0x1004U))) /* AES key source selection */
#define CSU_AES_KEY_LOAD  (*((volatile uint32_t*)(CSU_BASE + 0x1008U))) /* Loads the key selected by AES_KEY_SRC into the AES (self clearing) */
#define CSU_AES_START_MSG (*((volatile uint32_t*)(CSU_BASE + 0x100CU))) /* Starts the decryption process. The IV must be loaded before the AES will decrypt a payload (self clearing) */
#define CSU_AES_RESET     (*((volatile uint32_t*)(CSU_BASE + 0x1010U)))
#define CSU_AES_KEY_CLEAR (*((volatile uint32_t*)(CSU_BASE + 0x1014U)))
#define CSU_AES_CFG       (*((volatile uint32_t*)(CSU_BASE + 0x1018U))) /* 0=Dec, 1=Enc */
#define CSU_AES_KUP_WR    (*((volatile uint32_t*)(CSU_BASE + 0x101CU)))
#define CSU_AES_KUP       (*((volatile uint32_t*)(CSU_BASE + 0x1020U))) /* 32 bytes - through 0x40 */
#define CSU_AES_IV        (*((volatile uint32_t*)(CSU_BASE + 0x1040U))) /* 16 bytes - through 0x50 */
...
/* PUF */
#define CSU_PUF_CMD     (*((volatile uint32_t*)(CSU_BASE + 0x4000U)))
#define CSU_PUF_CFG0    (*((volatile uint32_t*)(CSU_BASE + 0x4004U)))
#define CSU_PUF_CFG1    (*((volatile uint32_t*)(CSU_BASE + 0x4008U)))
#define CSU_PUF_SHUTTER (*((volatile uint32_t*)(CSU_BASE + 0x400CU)))
#define CSU_PUF_STATUS  (*((volatile uint32_t*)(CSU_BASE + 0x4010U)))
#define CSU_PUF_WORD    (*((volatile uint32_t*)(CSU_BASE + 0x4018U)))
...
/* SHA3 */
#define CSU_SHA_START  (*((volatile uint32_t*)(CSU_BASE + 0x2000U)))
#define CSU_SHA_RESET  (*((volatile uint32_t*)(CSU_BASE + 0x2004U)))
#define CSU_SHA_DONE   (*((volatile uint32_t*)(CSU_BASE + 0x2008U)))
#define CSU_SHA_DIGEST (*((volatile uint32_t*)(CSU_BASE + 0x2010U))) /* 48 bytes (through 0x40) */
#define CSU_SHA_START  (*((volatile uint32_t*)(CSU_BASE + 0x2000U)))
#define CSU_SHA_START  (*((volatile uint32_t*)(CSU_BASE + 0x2000U)))
...
#define CSUDMA_ADDR(ch)     (*((volatile uint32_t*)(CSUDMA_BASE(ch) + 0x0000U))) /* Mem address (lower 32-bits) */
#define CSUDMA_ADDR_MSB(ch) (*((volatile uint32_t*)(CSUDMA_BASE(ch) + 0x0028U))) /*             (upper 17 bits) */
#define CSUDMA_SIZE(ch)     (*((volatile uint32_t*)(CSUDMA_BASE(ch) + 0x0004U))) /* DMA transfer payload size */
#define CSUDMA_STS(ch)      (*((volatile uint32_t*)(CSUDMA_BASE(ch) + 0x0008U)))
#define CSUDMA_CTRL(ch)     (*((volatile uint32_t*)(CSUDMA_BASE(ch) + 0x000CU)))
#define CSUDMA_CTRL2(ch)    (*((volatile uint32_t*)(CSUDMA_BASE(ch) + 0x0024U)))
#define CSUDMA_CRC(ch)      (*((volatile uint32_t*)(CSUDMA_BASE(ch) + 0x0010U)))
#define CSUDMA_ISTS(ch)     (*((volatile uint32_t*)(CSUDMA_BASE(ch) + 0x0014U)))
#define CSUDMA_IEN(ch)      (*((volatile uint32_t*)(CSUDMA_BASE(ch) + 0x0018U)))
#define CSUDMA_IDIS(ch)     (*((volatile uint32_t*)(CSUDMA_BASE(ch) + 0x001CU)))
#define CSUDMA_IMASK(ch)    (*((volatile uint32_t*)(CSUDMA_BASE(ch) + 0x0020U)))
